...
def main() -> None:
    ...
    tools_analysis.register(mcp, client)
    tools_editorial.register(mcp, client)
    tools_export.register(mcp, client)
    tools_jobs.register(mcp, client)
    tools_production.register(mcp, client)
    tools_vision.register(mcp, client)
    mcp.run()
