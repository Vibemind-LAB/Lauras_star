    ...
    return [
        ...
        AgentSpec(
            ...
            system_message=(
                ...
                "fit='blur' is the DEFAULT (the whole picture is fitted into the format — "
                "nothing gets cropped); pass fit='crop' only for real camera footage where a "
                "tight vertical crop looks better. "
                "Reply exactly: EDITED export_id=<id> (one per render). Only for full-video "
