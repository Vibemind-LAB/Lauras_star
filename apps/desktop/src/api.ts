...
// --- AI runtimes and personas -------------------------------------------------
// The backend has served /ai/runtimes since migration 0025, and /ai/personas since
// the persona routes landed. Nothing in the app spoke to either until now.
