...
describe("HealthBadge", () => {
  it("accepts the visual-draft migration as the current backend schema", () => {
    render(
      <HealthBadge
        offline={false}
        health={{ status: "ok", version: "0.1.0", pipeline_version: "p", schema_version: 36 }}
      />,
    );

    expect(screen.getByText("API v0.1.0 · schema 36")).toBeTruthy();
  });
