# CLAUDE.md — Laura (projektlokale Anweisungen)

Diese Datei wird in jeder Claude-Code-Session in diesem Repo geladen. Sie ergänzt die
globale `~/.claude/CLAUDE.md`. Hier stehen **projektspezifische** Regeln.
